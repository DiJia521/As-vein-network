        ...
        public IActionResult AddCompany(CompanyManage company)
        {
            if (company != null)
            {
                ...
                if (result != "失败")
                {
                    ...
                    Response.Redirect("/CompanyManage/SeadEmail?name=" + company.C_CompanyName+"&cphone="+company.C_CompanyPhone+"&email="+company.C_EmailAddress);
                }
            }
            return View();
        }
        public IActionResult SeadEmail( string name,string cphone,string email)
        {
